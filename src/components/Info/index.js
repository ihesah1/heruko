...
const Info = () => {
  return (
    <div className="infoWrapper">
      ...
      <div className="felx-container">
        <h2 className="name">Hesah Alharbi</h2>
      </div>
      <div className="felx-container">
        <h2 className="jobTitle">Developer</h2>
      </div>
      <hr className="line" />
      <div className="loction-email">
        <div className="felx-container">
          <svg
            ...
            class="info-icon svg-inline--fa fa-location-arrow fa-w-16"
            role="img"
        ...
        <div className="felx-container">
          <svg
            ...
            data-prefix="fas"
            data-icon="envelope"
            class="info-icon svg-inline--fa fa-envelope fa-w-16"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
          ...
          <p className="info-parag">
            <a href="mailto:Hesah.shaman.elq.js@tuwaiq.edu.sa">
              Hesah.shaman.elq.js@tuwaiq.edu.sa
            </a>
          </p>
        </div>
      </div>
      ...
      <div className="felx-container">
        <a href="https://github.com/ibrahimalsaif-tuwaiq">
          <svg
            ...
            data-prefix="fab"
            data-icon="github"
            class="github svg-inline--fa fa-github fa-w-16"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
          >
